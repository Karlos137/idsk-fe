...
const TableUsers = () => {
  const { data, loading, error, totalCount } = useFetchUsers()
        ...
        <table className='gov-table gov-table--tablet-block'>
          <thead>
            <tr>
              ...
              <th>
                <SortTableHeader name='firstName'> Jméno </SortTableHeader>
              </th>
              <th>
                <SortTableHeader name='lastName'> Příjmení </SortTableHeader>
              </th>
              <th>
              ...
              <th>Role</th>
              <th>
                <SortTableHeader name='email'> E-mail </SortTableHeader>
              </th>
              <th>
                <SortTableHeader name='phone'> Telefon </SortTableHeader>
              </th>
